...
class OrderListModel extends Model {
    ...
    public function getOrderList($mWhere = '', $mOrder = '', $type = '') {
        ...
        $fields = "order_list.order_id,order_list.order_sn,order_list.add_time,order_list.shop_id,order_list.buyer_name,order_list.qq,order_list.is_cus,"
                . "order_list.memo,order_list.order_state,order_list.order_amount,order_list.shipping_fee,order_list.shipping_code,order_list.shipping_name,"
                . "order_goods.img_path,order_goods.goods_id,order_goods.goods_name,order_goods.distribution_price goods_price,order_goods.buyer_goods_no,order_goods.goods_num,"
