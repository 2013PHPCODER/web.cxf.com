...
<div class="box-body">
    <div class="row" >
        <form class="form-inline" method="get" action="<?php echo U('system/power/logs');?>" id="form_search" onsubmit="return X.toSerchVaild(this)">
            ...
            <div class="form-group">
                <select class="form-control input-xs" name="id">
                    ...
                    <?php if(is_array($users)): foreach($users as $key=>$q): ?><option value="<?php echo ($q["id"]); ?>"><?php echo ($q["name"]); ?></option><?php endforeach; endif; ?>      
                </select>
            </div>
            <div class="form-group">
