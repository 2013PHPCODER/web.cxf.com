...
<!--                         <li data-cate="pageManage" >
            ...
            <section class="content">
                <ol class="breadcrumb">
    <li><i class="fa fa-dashboard"></i> 敏感词</li>
    <li>修改</li>
</ol> 				
...
<div class="dalog-modal" id="">
    ...
    <div class="g-modal-content">
        <form class="form-inline" method="post" action="<?php echo U('system/pageManage/editSensitive');?>">
            <div class="row">
                <label for="exampleInputName2">内容:</label>&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" class="form-control input-xs" value="<?php echo ($list["sensitive"]); ?>" maxlength="20"   placeholder="(20个字符以内)" name="sensitive">
            </div>
            <!--div class="row">
                <label for="exampleInputName2">类型:</label>&nbsp;&nbsp;&nbsp;&nbsp;
                <select class="form-control input-xs" name="type">
                    <option value="政治" <?php echo xeq($list['type'],'政治','selected');?>>政治</option>
                    <option value="暴力" <?php echo xeq($list['type'],'暴力','selected');?>>暴力</option>
                    <option value="涉黄" <?php echo xeq($list['type'],'涉黄','selected');?>>涉黄</option>
                    <option value="赌博" <?php echo xeq($list['type'],'赌博','selected');?>>赌博</option>
                </select>
            </div>				
            <div class="row">
                <label for="exampleInputName2">等级:</label>&nbsp;&nbsp;&nbsp;&nbsp;
                <select class="form-control input-xs" name="grade">
                    <option value="1" <?php echo xeq($list['grade'],1,'selected');?>>1</option>
                    <option value="2" <?php echo xeq($list['grade'],2,'selected');?>>2</option>
                    <option value="3"<?php echo xeq($list['grade'],3,'selected');?>>3</option>
                </select>
            </div-->
            <div style="margin: 20px 0;font-size: 18px;text-align: left;padding-left: 20px;">
            ...
            <div class="sub-btn"><input type="submit" class="btn btn-primary sumb btn1" value="确定"/><input type="button" class="btn btn-primary sumb btn-cancel" value="取消"/></div>
        </form>
    </div>
</div>
<style>
