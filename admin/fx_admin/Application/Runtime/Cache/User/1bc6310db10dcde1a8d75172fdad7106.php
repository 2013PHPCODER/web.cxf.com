    ...
    <div class="box-body">
        <form class="form-inline" method="get" action="" id="form_search" onsubmit="return X.toSerchVaild(this)">
            ...
            <div class="row" >
                ...
                <div class="form-group">
                    <input type="text" <?php echo xeq(I('get.order_search'),'','disabled');?> name="search_word" class="form-control input-xs" value="<?php echo I('get.search_word');?>"  placeholder="请填写具体的搜索条件">
                </div>
                <div class="form-group">
    ...
    <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
            ...
            <?php if(is_array($datas["list"])): $i = 0; $__LIST__ = $datas["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vo["buy_account_num"]); ?></td> 
                    <td><?php echo ($vo["receiver_money"]); ?></td>      
                    <td><a href="<?php echo U('user/actingDetail',array('id'=>$vo['id'],'username'=>$vo['user_account']));?>" class="fqy_gysLook">销售详情</a></td>
