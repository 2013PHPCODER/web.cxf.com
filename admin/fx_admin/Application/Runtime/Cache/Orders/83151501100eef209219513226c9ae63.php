            ...
            <div class=" order_detail box">
                <div class="box-body table-responsive no-padding ">
                    ...
                    <h4 class="order_type">售后状态：
                        ...
                        <?php switch($datas["refund_status"]): case "1": ?>平台待确认<?php break;?>
                        <?php case "2": ?>平台拒绝<?php break;?>
                        <?php case "3": ?>待供应商确认<?php break;?>
                        <?php case "4": ?>待仲裁<?php break;?>
                        <?php case "5": ?>待平台支付<?php break;?>
                        <?php case "6": ?>已完成<?php break; endswitch; endif; ?>
                        <?php if(($datas["return_status"]) > "0"): ?>退款退货状态：
                        <?php switch($datas["return_status"]): case "1": ?>平台待确认<?php break;?>
                        <?php case "2": ?>平台拒绝<?php break;?>
                        <?php case "3": ?>等待买家发货<?php break;?>
                        <?php case "4": ?>等待供货商收货<?php break;?>
                        <?php case "5": ?>待平台打款<?php break;?>
                        <?php case "6": ?>等待供货商补款<?php break;?>
                        <?php case "7": ?>待仲裁<?php break;?>
                        <?php case "8": ?>已完成<?php break; endswitch; endif; endif; ?>	
                    </h4>
                </div>
            </div>
            ...
            <div class=" order_detail box">
                ...
                <div class="box-body table-responsive no-padding ">
                    <div class="order_type">
                        ...
                        <p>订单来源：<?php echo ($datas["shop_id"]); ?></p>
                    ...
                    <div class="order_type ">
                        <p>分销商账户：<?php echo ($datas["buyer_name"]); ?></p>
                        <!-- <p>分销商ID：<?php echo ($datas["buyer_id"]); ?></p> -->
                        <p>联系方式：<?php if($datas['qq']): ?><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($datas["qq"]); ?>&site=qq&menu=yes"><img border="0" src="/Public/images/qq.png" alt="点击这里给我发消息" title="点击这里给我发消息"/></a><?php endif; if($datas['mobile_phone']): ?>&nbsp;&nbsp;&nbsp;&nbsp;手机号：13911229900<?php endif; ?></p>
                        <p>分销商留言：</p>
                        <div class="memo"><?php if($datas['message_starts'] == 1): if(is_array($datas["order_message"])): $i = 0; $__LIST__ = $datas["order_message"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$om): $mod = ($i % 2 );++$i; echo ($om["addtime"]); ?>&nbsp;&nbsp;<?php switch($om["user_type"]): case "1": ?>贷应商<?php break; case "2": ?>管理员<?php break; case "3": ?>分销商<?php break; endswitch;?>&nbsp;&nbsp;<?php echo ($om["message"]); ?><br><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td colspan="9"><h4 class="order_info">商品总数：<strong>&nbsp;<?php echo ($datas["goods_num_total"]); ?>&nbsp;件</strong></h4>
                                <h4 class="order_info">实收款：<strong>&nbsp;<?php echo ($datas["order_amount"]); ?> + <?php echo ($datas["shipping_fee"]); ?>(运费) = <?php echo ($datas["pay_amount"]); ?>&nbsp;元</strong></h4></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
