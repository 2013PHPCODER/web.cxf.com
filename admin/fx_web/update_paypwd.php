                        ...
                        <div class="cont-box">
                            ...
                            <div class="cont-box-body change-pad">
                                <div class="change-cont" style="display: block;">
                                    <div class="change-box user-center" id="next-pass" style="display: none;">
                                    ...
                                    <div class="change-box user-center" id="pay-pop" style="display: block;">
                                    	...
                                    	<label for=""><div class="sec-code"><span>填写验证码：</span><input type="text" class="s-code"><span class="s-send"  id="old_up">发送验证码</span></div></label>
