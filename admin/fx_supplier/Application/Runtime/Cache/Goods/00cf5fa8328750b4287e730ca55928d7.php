...
<block name="footerJs"> 
    ...
    <script type="text/javascript">
        ...
        uploader.on('uploadFinished', function (file) {
            ...
            if (uploadReturnData.returnData._total_ok > 0 && uploadReturnData.returnData._total_ok == uploadReturnData.returnData._total_num) {
                layer.confirm('全部上传成功', {
                    btn: ['查看', '关闭'] //按钮
                }, function () {
                    location.href = "<?php echo U('goods/goods/index',array('group_id'=>2,'menu_id'=>1,'second_menu_id'=>4));?>";
                }, function () {
                    location.reload();
                });
                return;
            }
            if (uploadReturnData.returnData._total_num > 0 && uploadReturnData.returnData._total_num > uploadReturnData.returnData._total_ok) {
